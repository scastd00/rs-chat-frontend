...
function PrivacyPolicy() {
  return (
    <Container>
      ...
      <h1>Privacy Policy for RS Chat</h1>

      <p>
        At RS Chat, accessible from{' '}
        <a href='#'>https://rschat.vercel.app/</a>, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is
        collected and recorded by RS Chat and how we use it.
      </p>
      ...
      <p>
        ...
        to the information that they shared and/or collect in RS Chat. This policy is not applicable to any
      ...
      <p>
        RS Chat follows a standard procedure of using log files. These files log visitors when they visit
      ...
      <p>
        You may consult this list to find the Privacy Policy for each of the advertising partners of RS Chat.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on RS Chat, which are sent directly to users'
      ...
      <p>
        Note that RS Chat has no access to or control over these cookies that are used by third-party
        advertisers.
      </p>
      ...
      <p>
        RS Chat's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
